...
export default function PrecosPage() {
  ...
  const [fonte, setFonte] = useState<'comprasgov'|'pncp'|'ambas'>(
    (search.get('fonte') as any) || 'comprasgov'
  );
  ...
  return (
    <main className="p-6 max-w-5xl mx-auto">
      <div className="flex items-center justify-between mb-4">
        <h1 className="text-2xl font-bold">Preços vencedores (similares)</h1>
        <Link href="/" className="text-sm text-indigo-600 hover:underline">Voltar</Link>
      </div>
